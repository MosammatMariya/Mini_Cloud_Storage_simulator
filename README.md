...
Users receive notifications when another user shares a file with them. Each notification contains information about the sender, the shared file, and the sharing time.
-Favourite Files
